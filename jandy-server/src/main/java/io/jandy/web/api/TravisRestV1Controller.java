 ...
 */
@RestController
@RequestMapping("/rest/travis/v1")
public class TravisRestV1Controller {
  private static final Logger logger = LoggerFactory.getLogger(TravisRestV1Controller.class);
      ...
      try (InputStreamReader reader = new InputStreamReader(file.getInputStream(), Charsets.UTF_8)) {
        ...
        try (BufferedReader br = new BufferedReader(reader)) {
          ...
          while ((line = br.readLine()) != null) {
            context.getTreeNodes().add(gson.fromJson(line, TreeNode.class));
          }
        }
